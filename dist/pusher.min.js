...
!1):a.detachEvent("on"+b,c)},isXHRSupported:function(){var b=xhook.XMLHttpRequest;return b&&(new b).withCredentials!==void 0},isXDRSupported:function(b){var c=Pusher.Util.getDocumentLocation().protocol;return window.XDomainRequest&&c===(b?"https:":"http:")}}}).call(this);
